...
export default function TermsPage() {
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar logo={<UserPlus className="h-6 w-6 text-purple-600" />} appName="LeadExtract" />
      <div className="flex-1 bg-white py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-4xl font-bold mb-8">Terms of Service</h1>
          <div className="prose">
            <p className="text-gray-600 mb-6">Last updated: {new Date().toLocaleDateString()}</p>
            <section className="mb-8"><h2 className="text-2xl font-semibold mb-4">1. Service</h2><p className="text-gray-700">LeadExtract provides services as described. You own your data.</p></section>
            ...
            <section className="mb-8"><h2 className="text-2xl font-semibold mb-4">4. Contact</h2><p className="text-gray-700">Questions? Email: legal@leadextract.com</p></section>
          </div>
        </div>
      </div>
