      ...
      <div className="flex-1 bg-white py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose">
            ...
            <section className="mb-8"><h2 className="text-2xl font-semibold mb-4">1. Service</h2><p className="text-gray-700">RevenueView provides services as described. You own your data.</p></section>
            ...
            <section className="mb-8"><h2 className="text-2xl font-semibold mb-4">4. Contact</h2><p className="text-gray-700">Questions? Email: legal@revenueview.com</p></section>
          </div>
        </div>
      </div>
