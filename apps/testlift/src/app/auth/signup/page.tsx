      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold">TestLift</span>
          </Link>
        </div>
        <Card>
          <CardHeader>
            <CardTitle>Create account</CardTitle>
            <CardDescription>Start optimizing conversions</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-xs text-center text-gray-500">By signing up, you agree to our <Link href="/terms" className="text-orange-600 hover:underline">Terms</Link> and <Link href="/privacy" className="text-orange-600 hover:underline">Privacy Policy</Link></p>
            </form>
            <div className="mt-6 text-center"><p className="text-sm">Already have an account? <Link href="/auth/signin" className="text-orange-600 hover:underline font-medium">Sign in</Link></p></div>
          </CardContent>
        </Card>
      </div>
    </div>
