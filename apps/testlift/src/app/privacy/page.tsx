      ...
      <div className="flex-1 bg-white py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8"><h2 className="text-2xl font-semibold mb-4">1. Data Collection</h2><p className="text-gray-700">We collect: account info, test data, visitor analytics, payment data (via Stripe).</p></section>
            ...
            <section className="mb-8"><h2 className="text-2xl font-semibold mb-4">4. Rights</h2><p className="text-gray-700">Access, export, delete your data anytime. Contact privacy@testlift.com</p></section>
          </div>
        </div>
      </div>
