...
export default function ComparePage() {
  ...
  const steps = [
    {
      ...
      description: "Help us find the right landlord insurance for your rental",
    },
    {
      title: "Property Details",
      description: "What type of rental property do you have?",
    },
    {
      title: "Your Contact Info",
      description: "We'll send personalized landlord insurance quotes",
    },
  ];
  ...
  const handleOccupancyRateChange = (value: string) => {
  ...
  const handleNextStep = () => {
    if (currentStep === 0) {
      if (!formData.propertyValue) {
        setError("Please enter your property value");
        return;
      }
    } else if (currentStep === 1) {
      if (!formData.propertyType || !formData.units) {
  ...
  if (completed) {
    return (
      <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-green-50 to-teal-50 py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="card text-center mb-8">
            ...
            <p className="text-gray-600 mb-8">
              We found {quotes.length} landlord insurance options for your rental property. Compare them below or check
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-600 mb-6">
              If you're interested in promoting landlord insurance to property owners and managers, join these
              affiliate programs and earn commissions:
            </p>
            <AffiliateComparisonTable
              programs={getAffiliatesByNiche("landlord")}
              siteName="Landlord Insurance"
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="card">
          ...
          {currentStep === 0 && (
            <div className="space-y-6">
              <div className="form-group">
                <label className="form-label">Approximate property value</label>
                <input
                  type="number"
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div className="form-group">
                <label className="form-label">Type of rental property</label>
                <select
                ...
                >
                  ...
                  <option value="apartment_building">Apartment Building (5+ units)</option>
                  <option value="commercial">Commercial Property</option>
                </select>
              </div>

              <div className="form-group">
                <label className="form-label">How many rental units?</label>
                <select
              ...
              <div className="form-group">
                <label className="form-label">Current occupancy rate</label>
                {[
                  { value: "excellent", label: "Excellent (100%)" },
                  { value: "good", label: "Good (80-99%)" },
                  { value: "fair", label: "Fair (50-79%)" },
                  { value: "vacant", label: "Recently Vacant" },
                ].map((option) => (
                  <button
                    key={option.value}
                    onClick={() => handleOccupancyRateChange(option.value)}
                    className={`w-full p-3 rounded-lg border-2 text-left transition-all mb-2 ${
                      formData.occupancyRate === option.value
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <div className="form-group">
                <label className="form-label">Property Zip Code / Location</label>
                <input
                  type="text"
                  placeholder="12345"
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  ℹ️ Landlord insurance typically costs $500-1500/year depending on property value and location. It
                  covers building damage, liability, and loss of rent.
                </p>
              </div>
            </div>
          )}
