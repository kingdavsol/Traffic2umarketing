...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      {!user?.isPremium && <AdBanner placement="bottom" appId="habit-tracker" />}
    </div>
  );
}
