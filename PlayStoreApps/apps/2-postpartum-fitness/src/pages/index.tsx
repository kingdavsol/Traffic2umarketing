/**
 * PostPartum Fitness - Landing Page
 * Phase-specific postpartum recovery workouts designed by pelvic floor physical therapists.
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">PostPartum Fitness</span>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-rose-500 to-pink-500">
          Science-backed recovery workouts for new mothers
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link href="/signup" className="bg-gradient-to-r from-rose-500 to-pink-500 text-white px-8 py-4 rounded-lg font-semibold text-lg transition transform hover:scale-105">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20" id="features">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white rounded-lg shadow-lg p-8 border-l-4 rose-500">
            <h3 className="text-xl font-bold mb-3">Pelvic Floor Focus</h3>
            <p className="text-gray-600">Premium access to advanced pelvic floor focus capabilities</p>
          </div>

          {/* Feature 2 */}
          <div className="bg-white rounded-lg shadow-lg p-8 border-l-4">
            <h3 className="text-xl font-bold mb-3">Recovery Phases</h3>
            <p className="text-gray-600">Specialized tools built for your specific needs</p>
          </div>

          {/* Feature 3 */}
          <div className="bg-white rounded-lg shadow-lg p-8 border-l-4">
            <h3 className="text-xl font-bold mb-3">PT-Verified Content</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="border-2 border-blue-500 rounded-xl p-8 bg-blue-50 relative transform md:scale-105">
            ...
            <div className="text-4xl font-bold mb-6">$11.99<span className="text-lg text-gray-600">/month</span></div>
      ...
      <footer className="bg-gray-900 text-gray-400 text-sm py-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p>© 2024 PostPartum Fitness. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
