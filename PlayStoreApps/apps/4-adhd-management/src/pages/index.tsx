/**
 * ADHD Management - Landing Page
 * ADHD-specific productivity app with hyperfocus timers, task breakdown AI, and body doubling.
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">ADHD Management</span>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-yellow-500">
          ADHD-specific tools for focus, productivity, and mental health
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link href="/signup" className="bg-gradient-to-r from-orange-500 to-yellow-500 text-white px-8 py-4 rounded-lg font-semibold text-lg transition transform hover:scale-105">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20" id="features">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white rounded-lg shadow-lg p-8 border-l-4 orange-500">
            <h3 className="text-xl font-bold mb-3">Hyperfocus Timer</h3>
            <p className="text-gray-600">Premium access to advanced hyperfocus timer capabilities</p>
          </div>

          {/* Feature 2 */}
          <div className="bg-white rounded-lg shadow-lg p-8 border-l-4">
            <h3 className="text-xl font-bold mb-3">Task Breakdown AI</h3>
            <p className="text-gray-600">Specialized tools built for your specific needs</p>
          </div>

          {/* Feature 3 */}
          <div className="bg-white rounded-lg shadow-lg p-8 border-l-4">
            <h3 className="text-xl font-bold mb-3">Dopamine Menu</h3>
      ...
      <footer className="bg-gray-900 text-gray-400 text-sm py-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p>© 2024 ADHD Management. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
