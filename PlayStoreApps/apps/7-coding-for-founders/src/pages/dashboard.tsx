...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white px-4 py-6">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {/* Premium CTA */}
        {!user?.isPremium && (
          <div className="bg-gradient-to-r from-indigo-500 to-blue-500 rounded-lg p-8 text-center text-white">
      ...
      {!user?.isPremium && <AdBanner placement="bottom" appId="coding-for-founders" />}
    </div>
  );
}
