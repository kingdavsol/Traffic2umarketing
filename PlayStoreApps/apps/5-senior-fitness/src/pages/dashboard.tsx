...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-400">
            <p className="text-gray-600 text-sm">Balance Score</p>
        ...
        {/* Premium CTA */}
        {!user?.isPremium && (
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg p-8 text-center text-white">
      ...
      {!user?.isPremium && <AdBanner placement="bottom" appId="senior-fitness" />}
    </div>
  );
}
