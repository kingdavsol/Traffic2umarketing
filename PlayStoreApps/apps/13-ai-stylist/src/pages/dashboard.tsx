...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      <div className="bg-gradient-to-r from-pink-500 to-rose-500 text-white px-4 py-6">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-400">
            <p className="text-gray-600 text-sm">Style Score</p>
            <h3 className="text-3xl font-bold text-gray-900">0</h3>
          </div>
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-purple-400">
            <p className="text-gray-600 text-sm">Outfits</p>
            <h3 className="text-3xl font-bold text-gray-900">0</h3>
          </div>
      ...
      {!user?.isPremium && <AdBanner placement="bottom" appId="ai-stylist" />}
    </div>
  );
}
